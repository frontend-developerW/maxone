...
import { getBrands, getCategorys, getProducts } from "../requests";
...
function Products() {
  ...
  return searchValue.length > 4 ? (
    ...
    <div className="flex justify-between p-[7vw] pt-0 items-start">
      <div className={`md:bg-[#8cc5ff5b] md:h-auto h-[90vh] md:overflow-hidden overflow-y-scroll z-50 bg-[#c7e3ff] md:w-[25%] w-[90vw] md:left-auto left-[5vw] md:rounded-[2vw] rounded-[4vw] md:p-[3vw] p-[8vw] md:relative fixed transition-[.5s] md:top-0 md:z-0 ${filterView ? 'top-[10vh]' : 'top-[-200vh]'}`}>
            ...
            {categorys.map((item, i) => (
              <button
                ...
                className={` bg-[#fff] md:p-[.5vw] p-[2vw] md:px-[1vw] px-[5vw] rounded-[6vw] md:text-[.9vw] text-[4vw] ${
                  (category === item && "bg-[#004B99] text-[#ffffff]") ||
                  "text-[#004B99] "
                }`}
              >
